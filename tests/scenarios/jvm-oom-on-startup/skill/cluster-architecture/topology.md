...
Entry points (nothing calls them): accounting, fraud-detection, jaeger-agent, jaeger-collector, jaeger-query, kubernetes, opensearch, opensearch-headless, otel-collector-agent-fxhxp, postgresql, valkey-cart
